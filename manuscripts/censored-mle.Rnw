% Time-stamp: <2017-05-04 20:51:55 (slane)>
...
\begin{figure}
  \centering
  \subfloat[Vessel-level intercepts coloured by vessel type.\label{fig:m1-reg-a}]{\includegraphics[width=0.45\linewidth]{../graphics/plM1boat.pdf}}
  \subfloat[Vessel-level intercepts coloured by anti-fouling paint type.\label{fig:m1-reg-b}]{\includegraphics[width=0.45\linewidth]{../graphics/plM1paint.pdf}}
...
Figure~\ref{fig:m3-reg-a} is suggestive of an interaction between the number of days since the vessel was last used and the vessel type, however an interaction between the median number of trips undertaken by the vessel and the vessel type or the anti-fouling paint (Figure~\ref{fig:m3-reg-b}) type do not appear likely. These observations led to the development of \ref{eq:M4} as the most likely model.\footnote{Fix these figures so they appear the same.}

\begin{figure}
  \centering
  \subfloat[Vessel-level intercepts coloured by vessel type.\label{fig:m3-reg-a}]{\includegraphics[width=0.45\linewidth]{../graphics/plM3boat.pdf}}
...
Figure~\ref{fig:m4-reg} shows the regression estimates from \ref{eq:M4}, in relation to the estimated vessel-level intercepts. Figure~\ref{fig:m4-reg-a} shows the number of days since the vessel was last used and the vessel-type estimated interaction, and Figure~\ref{fig:m4-reg-b} shows the estimated effect of the number of days since the vessel was last cleaned (adjusted by vessel-type).

\begin{figure}
  \centering
  \subfloat[Vessel-level intercepts coloured by vessel type.\label{fig:m4-reg-a}]{\includegraphics[width=0.45\linewidth]{../graphics/plM4type.pdf}}
  \subfloat[Vessel-level intercepts coloured by vessel type.\label{fig:m4-reg-b}]{\includegraphics[width=0.45\linewidth]{../graphics/plM4days2.pdf}}
