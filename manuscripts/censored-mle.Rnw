% Time-stamp: <2017-05-03 16:59:38 (slane)>
...
Table XXX compares the models by their leave-one-out information criterion (looic, analogous to AIC, see \cite{Vehtari2016-dp}). Blah blah.

Figure YYY compares estimates of the measurement-level and vessel-level regression coefficients for each of the models.
