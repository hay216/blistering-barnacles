% Time-stamp: <2017-05-12 13:45:51 (slane)>
...
The results demonstrate relationships that are largely consistent with prior expectations. The number of days since the vessel was last cleaned is likely the most significant factor in the amount of wet weight of biomass present on the vessel. 
