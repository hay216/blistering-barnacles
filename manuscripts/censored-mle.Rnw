% Time-stamp: <2017-08-24 20:03:09 (slane)>
...
\usepackage[backend=biber,style=authoryear,natbib=true,url=false,doi=true]{biblatex}
...
Invasive marine non indigenous species (NIS) are a major threat to biodiversity leading to dramatic shifts in population, community and ecosystem dynamics, and many have serious environmental and economic implications \citep{Carlton1993-cc,Ruiz1997-ji,Vitousek1996-zr}. Vessels are the single most important vector for the introduction and spread of marine NIS globally \citep{Molnar2008-dm}, effectively removing natural barriers to dispersal, including ocean currents and distance \citep{Paini2012-md,Ruiz1997-ji}. For example, the annual cost (losses and control costs) to the United States resulting from the introduction of the Zebra mussel (\textit{Dreissena polymorpha}), Asian clam (\textit{Corbicula fluminea}) and Shipworm (\textit{Teredo navalis}) is estimated at over USD\$3bn \citep{Pimentel2011-pe}.

Knowledge of invasion processes and pathways for NIS in marine environments is still relatively poorly understood, and both research studies and government policies have tended to focus exclusively on initial points of invasion which are predominantly biofouling and ballast water from international commercial shipping \citep{Acosta2010-gd,Campbell2011-zq}. However, there is growing recognition of the role of recreational vessels as vectors of NIS \citep{Ashton2014-me,Clarke_Murray2011-wf,Minchin2006-ig}, and recent studies have revealed the significant risk of secondary introductions in stepping stone invasions \citep[e.g.][]{Burgin2011-rj,Clarke_Murray2011-wf,Hewitt2007-eo,Lacoursiere-Roussel2012-cw,Minchin2006-ig}, whereby the movement of vessels within domestic borders has the potential to translocate invasive species from one port or region to another \citep{Campbell2011-zq}. The secondary spread of NIS will ultimately determine the magnitude of economic and environmental damage caused by invasive species \citep{Zabin2014-ea}. Unlike large international and commercial shipping vessels, recreational yachts, boats and domestic fishing vessels are often unregulated by biosecurity agencies, and such vessels represent a significant gap in managing NIS in marine environments \citep{Zabin2014-ea}.

Recreational small vessels have been implicated in several high profile and significantly damaging incursions of NIS including the introduction of the black striped mussel (\textit{Mytilopsis sallei}) into a recreational marina in Darwin, Australia in 1999. Strong evidence suggests it was introduced by hull fouling on an international yacht, and detections of the mussel outside of the marina were traced to movement of smaller vessels. This species has similar ecological and morphological characteristics to the Zebra mussel and when it was discovered densities were as high as 24,000 per square metre \citep{Thresher1999-et}. This incursion was successfully eradicated, but even despite concerted attempts the majority of marine invasions have proved impossible. Difficulty controlling marine invasions has led to a focus on reducing the human-mediated spread of NIS from major ports via high risk transport vectors \citep{Drake2004-aj,Floerl2005-nu,Forrest2013-cl} and recreational craft may constitute the largest unregulated vector.

Biofouling is the most common pathway for introduction of marine NIS for both commercial and recreational vessels \citep{Acosta2010-gd,Hewitt2004-oz,Minchin2006-ig,Thresher1999-et}, and studies of international and domestic recreational boats has demonstrated a range of fouling rates, with most over 50\% and some as high as 80\% \citep{Ashton2014-me,Floerl2005-nu,Lacoursiere-Roussel2012-pk,Minchin2006-ig,Zabin2014-ea}. High variability in the extent of fouling of individual recreational vessels is also reported, irrespective of sample sizes and methodology \citep{Ashton2014-me,Brine2013-dz,Clarke_Murray2011-wf,Floerl2005-nu}. Fouling of ``niche'' areas may be the most important pathway as these areas can have considerably higher levels of fouling than the hull \citep{Lacoursiere-Roussel2012-pk} and include internal water systems and intake pipes, rudder, propeller, anchors/chain cabinets, sea chests, fishing rods and ropes \citep{Acosta2010-gd,Burgin2011-rj,Hewitt2007-eo,Minchin2006-ig}.

Characteristics of recreational boats that increase both the rate and extent of fouling are substantially different to those of commercial vessels \citep{Lacoursiere-Roussel2012-pk}. Small vessels can have irregular maintenance and cleaning schedules, may spend significant amounts of time in port where opportunities for colonization are high, travel at low speeds, and have varied presence and abundance of niche areas \citep{Brine2013-dz,Clarke_Murray2011-wf,Floerl2005-nu,Minchin2006-ig}. Considerable variation in boat users maintenance and vessel usage means there is equally likely to be variation in transport frequency and risk of NIS \citep{Floerl2005-nu}. In addition, recreational boats visit pristine and often protected marine areas which may be highly susceptible to invasive marine species and disconnected from commercial shipping ports and aquaculture \citep{Clarke_Murray2011-wf}.

Australia is bounded by ocean and therefore has a heavy reliance on shipping for international and domestic trade, and also has a large recreational boating fleet. It is therefore susceptible to the primary introduction and secondary spread of NIS from a range of different vessel types \citep{Piola2012-bf}. More than 250 non-indigenous marine species have been found in Australia and now dominate many inshore communities \citep{Thresher1999-et}. Biodiversity impacts on Australia’s unique marine biota as well as economic losses have been documented following the establishment of non-indigenous marine species. Impacts from secondary invasions are increasingly likely as recreational boating in Australia continues to increase. In the decade from 1999-2009 boat ownership increased by more than 36\% to more than 800,000 individual registered vessels nationwide \citep{Burgin2011-rj}. Most commercial and recreational vessels are not required to inspect their hulls for NIS upon entry or travel domestically within Australia, rather the government relies on education programs and voluntary actions by the vessel operators/owners \citep{Piola2012-bf}.

No movements of vessels are without risk but minimising translocation of species requires a relevant and transparent risk based assessment \citep{Campbell2011-zq}, and these are being investigated in Australia as part of proposed regulatory interventions \citep{Piola2012-bf}. If specific attributes of small vessels can be identified which increase fouling biomass and therefore facilitate the movement of NIS, then management actions and regulations can be implemented by authorities which could reduce their spread and impacts.

This paper investigates the recreational boating vector and aims to identify characteristics of recreational vessels which potentially increase the extent of fouling biomass. We develop predictive tools to estimate the effect of these vessel-level characteristics, including transport and maintenance history, on the biofouling wet weight biomass. Our data comprises samples collected from the hull and niche areas of small vessels from five locations in south-east Australia. While several studies have estimated fouling extent on a measure or index of in-situ fouling cover \citep[e.g.][]{Ashton2006-xw,Brine2013-dz,Floerl2005-nu} this may be the first to link vessel-level characteristics with the complete wet weight fouling biomass of individual vessels and may offer an alternative perspective to determine vessel characteristics which influence fouling extent.

The rest of the paper proceeds as follows: in Section~\ref{sec:methods} we provide details on the data and the statistical models used for analysis; in Section~\ref{sec:results} we present the results in detail for the full modelling procedure; and in Section~\ref{sec:discussion} we provide a discussion of the results.
...
Vessel-level data collected from owners included: dimensions of the vessel; the type of antifouling paint applied (ablative, hard, and self-polishing); voyage history (number of days since the vessel was last used, median number of trips per year); the number of days since the vessel was last cleaned; the surface area of the hull (m\up{2}); and the type of vessel (yacht, fishing vessel, and motor cruisers and others). Table~\ref{tab:sum} shows summary statistics for these observed characteristics.

For more details on the data collected during the survey, see Australian Government Natural Heritage Trust Project 46630 \citep{Hayes2007-mm}.

<<summTable,echo=FALSE,results="asis">>=
vesselsLong1 <- vessels %>%
    select(boatID, days1, days2, midTrips, ApproxHullSA) %>%
    gather(variable, value, -boatID)
vessSumm1 <- vesselsLong1 %>%
    group_by(variable) %>%
    summarise_at(vars(value),
                 funs(med = quantile(., 0.5),
                      q25 = quantile(., 0.25),
                      q75 = quantile(., 0.75)), na.rm = TRUE) %>%
    mutate(summ = paste0(
               formatC(med, digits = 1, format = "f"), " (",
               formatC(q25, digits = 1, format = "f"), ", ",
               formatC(q75, digits = 1, format = "f"), ")"),
           variable = recode(variable,
                             ApproxHullSA = "Hull surface area",
                             days1 = "Days since last used",
                             days2 = "Days since last cleaned",
                             midTrips = "Trips per year")) %>%
    ungroup()
vesselsLong2 <- vessels %>%
    select(boatID, boatType, paintType) %>%
    gather(variable, value, -boatID)
vessSumm2 <- vesselsLong2 %>%
    ...
    ungroup()
vessSumm <- bind_rows(
    vessSumm2 %>% select(value, summ),
    vessSumm1 %>% select(value = variable, summ)
)
attr(vessSumm, "row.names") <- rep("", nrow(vessSumm))
latex(vessSumm, file = "",
      rgroup = c("Boat type", "Paint type", "Numeric variables"),
      n.rgroup = c(3, 4, 4), booktabs = TRUE, rowlabel = NULL,
      colheads = c("", "Variable", "n (\\%) / median (IQR)"),
      collabel.just = c("l", "r"),
      col.just = c("l", "r"),
      where = "!hbp",
      label = "tab:sum",
      caption =
          "Summary statistics for vessel-level characteristics. Categorical variables are shown as n (\\%), and numeric variables are shown as median (interquartile range, IQR).")
...
miss <- miss[-nrow(miss),]
pattern <- data_frame(
    pat = paste0("(", miss[,1], ", ", miss[,2], ", ", miss[,3], ")"),
    n = rownames(miss)
)

@

There is missing data at the vessel-level; Table~\ref{tab:miss} displays the observed data pattern, shown as (Days since last used, Paint type, Days since last trip), where a 1 denotes the variable is observed, and a 0 denotes the variable is missing. We can see that there are \Sexpr{rownames(miss)[1]} observations with complete vessel-level data. There are \Sexpr{paste0(rownames(miss)[2:4], collapse = ",")} vessels missing data on the number of days since the vessel was last used (days1); the median number of trips by the vessel (midTrips); and the paint type (paintType) respectively. There are \Sexpr{paste0(rownames(miss)[5:6], collapse = ",")} vessels missing data on both the number of days since the vessel was last used and the median number of trips by the vessel (days1 and midTrips), and all of the number of days since the vessel was last used, the median number of trips by the vessel, and the type of paint (days1, paintType and midTrips) respectively.

<<missingness-table,results="asis">>=
latex(pattern, file = "",
      booktabs = TRUE, rowlabel = NULL, rowname = NULL,
      colheads = c("Observed data pattern", "Count"),
      collabel.just = c("r", "r"),
      col.just = c("r", "r"),
      where = "!hbp",
      label = "tab:miss",
      caption =
          "Observed data pattern for vessel-level characteristics. The patterns are shown as (Days since last used, Paint type, Days since last trip), where a 1 denotes the variable is observed, and a 0 denotes the variable is missing. A count of each type of pattern is shown.")
...
Quantitative risk analysis is an efficient and transparent way to estimate the potential of a vessel to transport NIS and could allow authorities to predict high risk recreational vessels based on their maintenance and travel histories \citep{Floerl2005-nu}. Based on the predictive performance of our models, we have demonstrated that vessel-level characteristics can be used to predict the amount of wet weight of fouling biomass that may be present on small vessels in Australia. The development of such predictive tools could aid authorities in assessing the risk posed by individual vessels and classifying those that are a risk of having high levels of fouling will potentially reduce the introduction and spread of invasive species \citep{Minchin2006-ig}.

The results demonstrate relationships that are largely consistent with prior expectations and include predictor variables related to the time since last cleaning and last use, how frequently the boat is used, the type of antifouling paint applied, and an interaction between the type of vessel and length of time since it was last used. This interaction indicates that different types of vessels, e.g. yachts, fishing boats and motor cruisers, can have varied fouling biomass even if their stationary periods are the same. The size of the vessel however, measured by the hull surface area, was not important in predicting biofouling levels. Perhaps somewhat unsurprising was that given the same frequency of use, different types of vessels and the type of antifouling paint were not important predictors of fouling biomass.

The number of days since the vessel was last cleaned is a significant factor in the amount of biomass that may be present; for example, consider a yacht that hasn’t been used in \Sexpr{round(mean(vessels[['days1']], na.rm = TRUE))} days (the mean number of days since the vessel was last used). The model predicts that for such a vessel, there is an 80\% probability that delaying cleaning by three months would result in an increase of wet weight biomass by \Sexpr{diffs[['diffDays2']][1]}gm, within a 0.5m\up{2} area on the hull of the vessel.
...
There is also clear evidence that the location of the sample is an important predictor for the wet weight of biomass. Figure~\ref{fig:coefs} shows a consistent result that the wet weight of biomass when sampled from the rudder ($\beta^{l2}$), is no different to samples made along the hull. Measurements made on samples from the keel however, are smaller than those made along the hull. This is not a characteristic of vessels, and thus cannot be used for management purposes; the location of the measurement does however need to be considered in any future work, and in particular may restrict vessel-level summaries of wet weight of biomass being analysed (for example, total wet weight of biomass). Previous studies have found fouling cover on boats can be up to ten times higher in niche areas than on hulls where antifouling paint and boat cleaning generally overlook \citep{Clarke_Murray2011-wf}, and therefore may be important pathways for NIS \citep{Lacoursiere-Roussel2012-pk,Zabin2014-ea}.

There are many inconsistencies in the literature about the characteristics of recreational vessels which can explain fouling extent, though several proposed characteristics include voyage time, time in the water and time since application of anti-fouling paint, frequency of vessel use and stationary period \citep{Ashton2006-xw,Floerl2005-nu,Lacoursiere-Roussel2012-pk}. Several previous studies have failed to find strong relationships between vessel characteristics and fouling extent or abundance \citep{Ashton2014-me,Clarke_Murray2011-wf,Floerl2005-nu}, and no relationship between fouling and environmental variables of temperature and salinity \citep{Clarke_Murray2011-wf}. Models of vessel characteristics to predict biofouling in these studies all had low predictive power. For example, the abundance of NIS on yacht hulls could not be associated with maintenance schedules, travel history or owners maintenance behaviour \citep{Floerl2005-nu} and percent fouling cover was not related to travel frequency or the age of antifouling paint \citep{Clarke_Murray2011-wf}. Despite low explanatory power, the most consistent predictor of fouling level on recreational boats is the age of antifouling paint \citep{Ashton2006-xw,Floerl2005-nu,Lacoursiere-Roussel2012-pk}, as well as time in the water, stationary periods, and voyage types \citep{Ashton2006-xw,Lacoursiere-Roussel2012-pk}. Even well maintained recreational vessels can transport NIS, with upwards of two-thirds of boats are still fouled even with high numbers of boats having anti fouling paint and manual cleaning \citep{Clarke_Murray2011-wf,Zabin2014-ea}. Even where the percentage of fouling cover may be small, the risk of NIS invasion may still be large due to the sheer number of boats and associated propagule pressure \citep{Clarke_Murray2011-wf}.

In contrast\footnote{Tracey is questioning this.} to our study, \citet{Ashton2014-me} did not find significant correlations between last cleaning and extent of fouling using in-water surveys. However location of the sample was important, as the propeller shafts was most frequently reported as having biofouling but highest numbers of organisms were on the keel, indicating that how well vessels are cleaned may be just as important as how often \citep{Ashton2014-me}. The type of recreational vessel also did not explain the extent of differences in biofouling. However vessel type can play a role as  powerboats and catermarans have great risk of fouling due to higher number of niche areas \citep{Lacoursiere-Roussel2012-pk}.
...
This study is not without its limitations. The small number of vessels sampled limits the precision at which we can estimate the effect of vessel-level characteristics, and in particular, any interactions between them. We demonstrated a possible interaction between the number of  days the vessel was last used and the type of vessel, yet the error in this estimate is sufficient enough that the effect may be either or positive or negative. Sample size reservations notwithstanding, we have demonstrated that vessel-level characteristics can be used to predict the amount of wet weight of biomass that may be present on small vessels in Australia. Differences in recreational boat use in different regions means that risk assessments should be regionally specific \citep{Lacoursiere-Roussel2012-pk}.

The results suggest that in particular, owners of small vessels should be encouraged to maintain a regular cleaning and maintenance schedule, particularly wet areas of the vessel. Management interventions, such as diver inspections, directive to clean at a dry dock etc, can be implemented to varying degrees based on increasing levels of risk, but also with a prohibitive increase in resources, cost and time \citep{Campbell2011-zq}. Therefore strategies and incentives could be investigated to encourage boat owners to improve their cleaning and maintenance, as well as education and outreach programs for boat owners to increase awareness of invasive species and their impacts \citep{Brine2013-dz,Minchin2006-ig}. Authorities could also introduce regulated antifouling paint regimes, e.g. every 12 months, regular inspections and providing cleaning facilities for recreational boat users \citep{Zabin2014-ea}. Many dry docks for recreational small vessels do not have the procedures and/or facilities to deal with the material removed from hull cleaning which is often released back into the ocean \citep{Hewitt2007-eo}. Even if only a small percentage of recreational boats have biofouling, the sheer number of boats around Australia mean that the number transporting NIS could in the tens of thousands. This danger can occur from just a few voyages of heavily fouled vessels, or large numbers of boats with minimal fouling but high transport frequency, and therefore propagule pressure is large \citep{Clarke_Murray2011-wf,Kauano2016-nk}.

Recreational boating is rising globally which makes it crucial to understand the risk associated with secondary spread of non-indigenous species locally, regionally and internationally \citep{Clarke_Murray2011-wf}. Small vessels could potentially have a significant impact on the secondary spread of NIS, even just due to the considerable and increasing number of recreational vessels and annual voyages \citep{Zabin2014-ea}. But limited knowledge and complexities within the recreational boating pathway means that risk based assessment and NIS management of the pathway is absent in most countries \citep{Acosta2010-gd} and concerns about recreational boating in the translocation of invasive species are often not acknowledged, even by local and international authorities \citep{Burgin2011-rj}. Preventing the introduction of invasive organisms is the key to reducing their spread, requiring stringent implementation of measures to reduce invasions through all vector routes \citep{Bax2001-vy}. No movements of vessels are without risk but minimising translocation of species will require a relevant and transparent risk based assessment \citep{Campbell2011-zq} and characterising the risk of biological invasions requires understanding species assemblages at ports and the characteristics of transport vectors \citep{Floerl2005-qo}. Recreational boating in particular has complex and interacting risks and invasion scenarios, which need to be modelled and assessed in order to implement effective biosecurity management programs \citep{Acosta2010-gd}.

\section*{Acknowledgements}
\label{sec:acknowledgements}

The authors would like to acknowledge Dr Enamul Kabir for his contribution to earlier analyses that were not a part of this manuscript. AR, SL and TH's contributions were funded in part by the Centre of Excellence for Biosecurity Risk Analysis.
