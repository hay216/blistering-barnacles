% Time-stamp: <2017-08-23 17:04:16 (slane)>
...
Invasive marine non indigenous species (NIS) are a major threat to biodiversity leading to dramatic shifts in population, community and ecosystem dynamics, and many have serious environmental and economic implications (Carlton and Geller 1993, Ruiz et al. 1997, Vitousek et al. 1996). Vessels are the single most important vector for the introduction and spread of marine NIS globally (Molnar et al. 2008), effectively removing natural barriers to dispersal, including ocean currents and distance (Paini and Yemshanov 2012, Ruiz et al. 1997). For example, the annual cost (losses and control costs) to the United States resulting from the introduction of the Zebra mussel (species name), Asian clam (species name) and Shipworm (species name)\footnote{Species names to be added.} is estimated at over USD\$3bn\citep{Pimentel2011-pe}.

Knowledge of invasion processes and pathways for NIS in marine environments is still relatively poorly understood, and both research studies and government policies have tended to focus exclusively on initial points of invasion which are predominantly biofouling and ballast water from international commercial shipping (Acosta et al. 2010, Campbell and Hewitt 2011). However, there is growing recognition of the role of recreational vessels as vectors of NIS (Ashton et al. 2014, Clarke Murray et al. 2011, Minchin et al. 2006), and recent studies have revealed the significant risk of secondary introductions in stepping stone invasions (e.g. Burgin and Hardiman 2011, Clarke Murray et al. 2011, Hewitt et al. 2007, Lacoursière-Roussel et al. 2012a, Minchin et al. 2006), whereby the movement of vessels within domestic borders has the potential to translocate invasive species from one port or region to another (Campbell and Hewitt 2011). The secondary spread of NIS will ultimately determine the magnitude of economic and environmental damage caused by invasive species (Zabin et al. 2014). Unlike large international and commercial shipping vessels, recreational yachts, boats and domestic fishing vessels are often unregulated by biosecurity agencies, and such vessels represent a significant gap in managing NIS in marine environments (Zabin et al. 2014).

Recreational small vessels have been implicated in several high profile and significantly damaging incursions of NIS including the introduction of the black striped mussel (Mytilopsis sallei) into a recreational marina in Darwin, Australia in 1999. Strong evidence suggests it was introduced by hull fouling on an international yacht, and detections of the mussel outside of the marina were traced to movement of smaller vessels. This species has similar ecological and morphological characteristics to the Zebra mussel and when it was discovered densities were as high as 24,000 per square metre (Thresher 1999). This incursion was successfully eradicated, but even despite concerted attempts the majority of marine invasions have proved impossible. Difficulty controlling marine invasions has led to a focus on reducing the human-mediated spread of NIS from major ports via high risk transport vectors (Drake and Lodge 2004, Floerl et al. 2005, Forrest and Hopkins 2013) and recreational craft may constitute the largest unregulated vector.

Biofouling is the most common pathway for introduction of marine NIS for both commercial and recreational vessels (Acosta et al. 2010, Hewitt et al. 2004, Minchin et al. 2006, Thresher 1999), and studies of international and domestic recreational boats has demonstrated a range of fouling rates, with most over 50\% and some as high as 80\% (Ashton et al. 2014, Floerl et al. 2005, Lacoursière-Roussel et al. 2012b, Minchin et al. 2006, Zabin et al. 2014). High variability in the extent of fouling of individual recreational vessels is also reported, irrespective of sample sizes and methodology (Ashton et al. 2014, Brine et al. 2013, Clarke Murray et al. 2011, Floerl et al. 2005). Fouling of ``niche'' areas may be the most important pathway as these areas can have considerably higher levels of fouling than the hull (Lacoursière-Roussel et al. 2012b) and include internal water systems and intake pipes, rudder, propeller, anchors/chain cabinets, sea chests, fishing rods and ropes (Acosta et al. 2010, Burgin and Hardiman 2011, Hewitt et al. 2007, Minchin et al. 2006).

Characteristics of recreational boats that increase both the rate and extent of fouling are substantially different to those of commercial vessels (Lacoursière-Roussel et al. 2012b). Small vessels can have irregular maintenance and cleaning schedules, may spend significant amounts of time in port where opportunities for colonization are high, travel at low speeds, and have varied presence and abundance of niche areas (Brine et al. 2013, Clarke Murray et al. 2011, Floerl et al. 2005, Minchin et al. 2006). Considerable variation in boat users maintenance and vessel usage means there is equally likely to be variation in transport frequency and risk of NIS (Floerl et al. 2005). In addition, recreational boats visit pristine and often protected marine areas which may be highly susceptible to invasive marine species and disconnected from commercial shipping ports and aquaculture (Clarke Murray et al. 2011).

Australia is bounded by ocean and therefore has a heavy reliance on shipping for international and domestic trade, and also has a large recreational boating fleet. It is therefore susceptible to the primary introduction and secondary spread of NIS from a range of different vessel types (Piola and McDonald 2012). More than 250 non-indigenous marine species have been found in Australia and now dominate many inshore communities (Thresher 1999). Biodiversity impacts on Australia’s unique marine biota as well as economic losses have been documented following the establishment of non-indigenous marine species. Impacts from secondary invasions are increasingly likely as recreational boating in Australia continues to increase. In the decade from 1999-2009 boat ownership increased by more than 36\% to more than 800,000 individual registered vessels nationwide (Burgin and Hardiman 2011). Most commercial and recreational vessels are not required to inspect their hulls for NIS upon entry or travel domestically within Australia, rather the government relies on education programs and voluntary actions by the vessel operators/owners (Piola and McDonald 2012).

No movements of vessels are without risk but minimising translocation of species requires a relevant and transparent risk based assessment (Campbell and Hewitt 2011), and these are being investigated in Australia as part of proposed regulatory interventions (Piola and McDonald 2012). If specific attributes of small vessels can be identified which increase fouling biomass and therefore facilitate the movement of NIS, then management actions and regulations can be implemented by authorities which could reduce their spread and impacts.

This paper investigates the recreational boating vector and aims to identify characteristics of recreational vessels which potentially increase the extent of fouling biomass. We develop predictive tools to estimate the effect of these vessel-level characteristics, including transport and maintenance history, on the biofouling wet weight biomass. Our data comprises samples collected from the hull and niche areas of small vessels from five locations in south-east Australia. While several studies have estimated fouling extent on a measure or index of in-situ fouling cover (e.g. Ashton et al. 2006, Brine et al. 2013, Floerl et al. 2005) this may be the first to link vessel-level characteristics with the complete wet weight fouling biomass of individual vessels and may offer an alternative perspective to determine vessel characteristics which influence fouling extent.
...
There is also clear evidence that the location of the sample is an important predictor for the wet weight of biomass. Figure~\ref{fig:coefs} shows a consistent result that the wet weight of biomass when sampled from the rudder ($\beta^{l2}$), is no different to samples made along the hull. Measurements made on samples from the keel however, are smaller than those made along the hull. This is not a characteristic of vessels, and thus cannot be used for management purposes; the location of the measurement does however need to be considered in any future work, and in particular may restrict vessel-level summaries of wet weight of biomass being analysed (for example, total wet weight of biomass). Previous studies have found fouling cover on boats can be up to ten times higher in niche areas than on hulls where antifouling paint and boat cleaning generally overlook (Clarke Murray et al. 2011), and therefore may be important pathways for NIS (Lacoursière-Roussel et al. 2012b, Zabin et al. 2014).

There are many inconsistencies in the literature about the characteristics of recreational vessels which can explain fouling extent, though several proposed characteristics include voyage time, time in the water and time since application of anti-fouling paint, frequency of vessel use and stationary period (Ashton et al. 2006, Floerl et al. 2005, Lacoursière-Roussel et al. 2012b). Several previous studies have failed to find strong relationships between vessel characteristics and fouling extent or abundance (Ashton et al. 2014, Clarke Murray et al. 2011, Floerl et al. 2005), and no relationship between fouling and environmental variables of temperature and salinity (Clarke Murray et al. 2011). Models of vessel characteristics to predict biofouling in these studies all had low predictive power. For example, the abundance of NIS on yacht hulls could not be associated with maintenance schedules, travel history or owners maintenance behaviour (Floerl et al. 2005) and percent fouling cover was not related to travel frequency or the age of antifouling paint (Clarke Murray et al. 2011). Despite low explanatory power, the most consistent predictor of fouling level on recreational boats is the age of antifouling paint (Ashton et al. 2006, Floerl et al. 2005, Lacoursière-Roussel et al. 2012b), as well as time in the water, stationary periods, and voyage types (Ashton et al. 2006, Lacoursière-Roussel et al. 2012b). Even well maintained recreational vessels can transport NIS, with upwards of two-thirds of boats are still fouled even with high numbers of boats having anti fouling paint and manual cleaning (Clarke Murray et al. 2011, Zabin et al. 2014). Even where the percentage of fouling cover may be small, the risk of NIS invasion may still be large due to the sheer number of boats and associated propagule pressure (Clarke Murray et al. 2011).

In contrast\footnote{Tracey is questioning this.} to our study Ashton et al (2014) did not find significant correlations between last cleaning and extent of fouling using in-water surveys. However location of the sample was important, as the propeller shafts was most frequently reported as having biofouling but highest numbers of organisms were on the keel, indicating that how well vessels are cleaned may be just as important as how often (Ashton et al. 2014). The type of recreational vessel also did not explain the extent of differences in biofouling. However vessel type can play a role as  powerboats and catermarans have great risk of fouling due to higher number of niche areas (Lacoursière-Roussel et al. 2012b).
...
This study is not without its limitations. The small number of vessels sampled limits the precision at which we can estimate the effect of vessel-level characteristics, and in particular, any interactions between them. We demonstrated a possible interaction between the number of  days the vessel was last used and the type of vessel, yet the error in this estimate is sufficient enough that the effect may be either or positive or negative. Sample size reservations notwithstanding, we have demonstrated that vessel-level characteristics can be used to predict the amount of wet weight of biomass that may be present on small vessels in Australia. Differences in recreational boat use in different regions means that risk assessments should be regionally specific (Lacoursière-Roussel et al. 2012b).

The results suggest that in particular, owners of small vessels should be encouraged to maintain a regular cleaning and maintenance schedule, particularly wet areas of the vessel. Management interventions, such as diver inspections, directive to clean at a dry dock etc, can be implemented to varying degrees based on increasing levels of risk, but also with a prohibitive increase in resources, cost and time (Campbell and Hewitt 2011). Therefore strategies and incentives could be investigated to encourage boat owners to improve their cleaning and maintenance, as well as education and outreach programs for boat owners to increase awareness of invasive species and their impacts (Brine et al. 2013, Minchin et al. 2006). Authorities could also introduce regulated antifouling paint regimes, e.g. every 12 months, regular inspections and providing cleaning facilities for recreational boat users (Zabin et al. 2014). Many dry docks for recreational small vessels do not have the procedures and/or facilities to deal with the material removed from hull cleaning which is often released back into the ocean (Hewitt et al. 2007). Even if only a small percentage of recreational boats have biofouling, the sheer number of boats around Australia mean that the number transporting NIS could in the tens of thousands. This danger can occur from just a few voyages of heavily fouled vessels, or large numbers of boats with minimal fouling but high transport frequency, and therefore propagule pressure is large (Clarke Murray et al. 2011, Kauano et al. 2016).

Recreational boating is rising globally which makes it crucial to understand the risk associated with secondary spread of non-indigenous species locally, regionally and internationally (Clarke Murray et al. 2011). Small vessels could potentially have a significant impact on the secondary spread of NIS, even just due to the considerable and increasing number of recreational vessels and annual voyages (Zabin et al. 2014). But limited knowledge and complexities within the recreational boating pathway means that risk based assessment and NIS management of the pathway is absent in most countries (Acosta et al. 2010) and concerns about recreational boating in the translocation of invasive species are often not acknowledged, even by local and international authorities (Burgin and Hardiman 2011). Preventing the introduction of invasive organisms is the key to reducing their spread, requiring stringent implementation of measures to reduce invasions through all vector routes (Bax et al. 2001). No movements of vessels are without risk but minimising translocation of species will require a relevant and transparent risk based assessment (Campbell and Hewitt 2011) and  characterising the risk of biological invasions requires understanding species assemblages at ports and the characteristics of transport vectors (Floerl and Inglis 2005). Recreational boating in particular has complex and interacting risks and invasion scenarios, which need to be modelled and assessed in order to implement effective biosecurity management programs (Acosta et al. 2010).
